...
class TestNotifyInterruptedCronJobs:
    ...
    async def test_owner_is_told_the_run_was_killed(self):
        ...
        assert adapter.sent_calls[0][2]["delivery_event_kind"] == "cron.failure"
        assert adapter.sent_calls[0][2]["delivery_event_channel"] == "alert"
        assert adapter.sent_calls[0][2]["delivery_alert_kind"] == "cron.failure"
