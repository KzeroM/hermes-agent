...
AUTHOR_MAP = {
    "KzeroM@users.noreply.github.com": "KzeroM",  # PR #5 (local automation contributor identity)
    "zeromo2000@gmail.com": "KzeroM",  # PR #5 (local automation contributor identity)
